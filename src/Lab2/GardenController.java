...
public class GardenController {
    ...
    public void initialize() {
        ...
        beeList.add(new BeeDirected(100, 100));
        beeList.add(new BeeRandom(600, 800));
        entityList.addAll(beeList);
        flowerList.add(new GoodFlower(450, 100));
        flowerList.add(new GoodFlower(450, 600));
        flowerList.add(new BadFlower(100, 350));
        flowerList.add(new BadFlower(800, 350));
